...
function get_todos() {
    ...
    comunicate with the browser to make the task a JavaScript object.*/
    if (todos_str !== null) {
        todos = JSON.parse(todos_str);
    }
    return todos;
}
/*This function adds the inpiuted task to the get_todos function array*/
function add() {
...
function show() {
    /* this set thte task that was retrieved as a variable*/
    var todos = get_todos();
...
/*This will keep the inputs desplayed permanently on the screen*/
show();
