...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            select.style.backgroundImage ='url("images/catx.png")';
            //Active player may only be 'X' or 'O' so, if not 'X' it must be 'O'
        } else {
            //If activePlayer is equal to 'O', the o.png is placed in HTML
            select.style.backgroundImage = 'url("images/doggo.png")';
        }
...
//This fucntion utilizes HTML canvas to draw win lines.
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        ...
        function animateLineDrawing() {
            ...
            c.beginPath();
            //This method move us to a starting poin in our line.
            c.moveTo(x1, y1);
...
function resetGame() {
    //Thios for loop iterates through each HTML square element.
    for (let i = 0; i < 9; i++) {
        //This variable get the HTML element i.
        let square = document.getElementById(String(i));
        //This removes our elements backgroudnImage.
